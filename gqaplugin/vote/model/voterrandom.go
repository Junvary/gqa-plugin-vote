...
type GqaPluginVoteVoterRandom struct {
	...
	VoterByUser   gqaModel.SysUser `json:"voterByUser" gorm:"foreignKey:Voter;references:Username"`
	...
	CreatedByUser gqaModel.SysUser `json:"createdByUser" gorm:"foreignKey:CreatedBy;references:Username"`
}
