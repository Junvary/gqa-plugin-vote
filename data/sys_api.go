...
var sysApiData = []system.SysApi{
	...
	{GqaModel: global.GqaModel{Status: "on", Sort: 708, Remark: "插件vote：投票结果查看已经投票人", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "plugin-vote", ApiPath: "/plugin-vote/vote-result-voted", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Status: "on", Sort: 709, Remark: "插件vote：投票结果列表", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "plugin-vote", ApiPath: "/plugin-vote/vote-result-list", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Status: "on", Sort: 710, Remark: "插件vote：投票结果图形", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "plugin-vote", ApiPath: "/plugin-vote/vote-result-chart", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Status: "on", Sort: 711, Remark: "插件vote：固定投票人列表", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "plugin-vote", ApiPath: "/plugin-vote/voter-list", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Status: "on", Sort: 712, Remark: "插件vote：新增固定投票人", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "plugin-vote", ApiPath: "/plugin-vote/voter-add", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Status: "on", Sort: 713, Remark: "插件vote：删除固定投票人", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "plugin-vote", ApiPath: "/plugin-vote/voter-delete", ApiMethod: "DELETE",
	},
	{GqaModel: global.GqaModel{Status: "on", Sort: 714, Remark: "插件vote：候选人列表", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "plugin-vote", ApiPath: "/plugin-vote/candidate-list", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Status: "on", Sort: 715, Remark: "插件vote：新增候选人", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "plugin-vote", ApiPath: "/plugin-vote/candidate-add", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Status: "on", Sort: 716, Remark: "插件vote：删除候选人", CreatedAt: time.Now(), CreatedBy: "admin"},
